...
Всё расписание студии представлены занятия всех форматов, спецпротоколов,
        бесплатная диагностика и анонсы. Приобретаете любые {threshold} занятия
        (основные форматы или дополнительные) в неделю — 4-е в подарок! Запись
        на диагностику и анонсированные занятия оформляется отдельно от основной
